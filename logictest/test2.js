...
/*PSEUDO
    STORE OjectTemp as Object
    FOR objectKey FROM 0 TO ArrLength INCREMENT BY1
        STORE jumlah as Number/0
        FOR objectAswer FROM 0 TO ArrLength INCREMENT BY 1
            IF ObjectKey EQUAL ObjectAnswer
                jumlah INCREMENT BY 1
            END IF
        END FOR
    END FOR
*/
